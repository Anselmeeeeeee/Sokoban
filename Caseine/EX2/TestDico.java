...
public class TestDico {
	final boolean DIAGNOSTICS = false;
	...
	void run(String[] args) {
		...
		if ((tests & (WORDS | WIDTH | DEPTHPRE | DEPTHINF | DEPTHPOST)) > 0) {
			...
			for (int i=0; i<it.length; i++) {
				...
				switch (r.nextInt(4)) {
					...
					case 2:
						...
						break;
					case 3:
						newit = dict.wordIterator();
						break;
				}
				it[i] = newit;
			}
			int rounds = r.nextInt(1000)+4000;
