...
public class Coup implements Commande {
	...
	public void execute() {
		deplacementPousseur(pousseur.depuisL, pousseur.depuisC, pousseur.depuisL + dirPousseurL, pousseur.depuisC + dirPousseurC);
		if(caisse != null){
			deplacementCaisse(caisse.depuisL, caisse.depuisC, caisse.depuisL + dirPousseurL, caisse.depuisC + dirPousseurC);
		}
	}
